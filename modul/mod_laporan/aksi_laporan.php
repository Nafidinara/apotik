...
if (empty($_SESSION['nik']) AND empty($_SESSION['passuser'])){
  ...
  $act=$_GET['act'];
    ...
    if ($module=='laporan' AND $act=='ganti'){
      ...
      $sq=mysqli_query($connection,"select C_KODEJAB from mskry WHERE C_NIP='$cnip_lama'");
      $dt =mysqli_fetch_array($sq);
      $C_KODEJAB=$dt['C_KODEJAB'];
          $insert = mysqli_query($connection,"INSERT INTO `laporan` (
                                                  `C_NIPLAMA`, 
                                                  `C_NIPBARU`, 
                                                  `C_NOTES`,
                                                  `D_TANGGAL`, 
          ...
          $update = mysqli_query($connection,"UPDATE mskry SET C_AYBS='$cnip_baru' WHERE C_AYBS='$cnip_lama'");
    ...
    elseif ($module=='laporan' AND $act=='delete'){
          ...
          $insert = mysqli_query($connection,"DELETE FROM `laporan` WHERE C_KODEJAB='$C_KODEJAB' ");                   
