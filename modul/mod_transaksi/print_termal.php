<?php
   include "../../config/koneksi.php";
	  ...
	  error_reporting(0);
		...
		$no = 1; 
		$g = mysqli_query($connection,"SELECT * from transaksi where id_transaksi='001'");
    ...
    $printTestText .= "----------------------------------------\n";
		...
		$no = 1; 
		$tampil = mysqli_query($connection,"SELECT * from order_temp o left join produk p on o.id_produk=p.c_prodcode");
