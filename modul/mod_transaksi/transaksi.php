	...
	<section class="content">
		<div class="row">
			...
			<div class="box">
				...
				<div class="box-body">
				<?php
echo"<form action='$aksi?module=transaksi' enctype='multipart/form-data' method='POST' class='form-horizontal'> ";?>
			...
			<div class="box box box-success box-solid">
				<div class="box-header">
				  <h3 class="box-title">Order Sementara</h3>
...
<a href="#ModalPen" class="btn btn-block btn-primary pull-right"  data-toggle="modal"><b> Tambah Produk</b></a>
			...
			<div class="modal-footer">
						<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
							<button onclick="AlertBerhasil()" type="submit" class="kirim btn btn-info pull-right">Kirim ke Laporan</button>
					</div>
				  </form>
</div>
  ...
  alert("Data berhasil di kirim ke laporan!");
}
    </script>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
				  ...
				  <form method="post" class="formPendidikan">
						...
						<script>									
							...
							$(document).ready(function(){
							  //apabila terjadi event onchange terhadap object <select id=propinsi>
										...
										<?php  	
													$connection = mysqli_connect("localhost", "root", "","apotik");
													$fetch1 = mysqli_query($connection,"select * from harga");
													$return_arr1 = array();
													$array1 = array();
													while ($item1 = mysqli_fetch_assoc($fetch1)) {
										...
										<div class="form-group">							
											<label for="inputPassword3" class="col-md-1 control-label">jml beli</label>
												<div class="col-md-4">
													<input type="number" class="form-control" name="jml" value="0">
												</div>
												<div class="col-md-4">
										...
										<div class="form-group">							
											<label for="inputPassword3" class="col-md-1 control-label">diskon</label>
												<div class="col-md-4">
													<div class="input-group">
														<input value="0" type="number" class="form-control" name="diskon">
					...
					<div class="modal-footer">
						<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
						<a type="submit" class="simpanPend btn btn-primary">Tambah</a>
					</div>
				  </form>
				</div>
			</div>
			...
			<div class="box">
				...
				<div class="box-body">
				  ...
				  <table id="hrd" class="display table table-bordered table-striped" width="100%">
					...
					<?php
						$no = 1;
						$tampil = mysqli_query($connection,"SELECT t.*,a.nama_lengkap from transaksi t left join admins a on t.created_user=a.nik order by t.id_transaksi desc");
			...
			<div class="box">
				...
				<form action="#" method="POST">
					...
					<table width="770" border="0" cellpadding="1" cellspacing="0">
					 ...
					 $connection = mysqli_connect("localhost", "root", "","apotik");
							$no = 1;
							$tampil = mysqli_query($connection,"SELECT * from detail_transaksi o left join produk p on o.c_codeprod=p.kd_obat where id_transaksi='$_GET[id_transaksi]'");
							while($r=mysqli_fetch_array($tampil)){
