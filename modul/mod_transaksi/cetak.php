<?php
   include "../../config/koneksi.php";
	  ...
	  error_reporting(0);
		...
		$no = 1; 
		$g = mysqli_query($connection,"SELECT * from transaksi where id_transaksi='002'");
   ...
   $item =str_pad("item",65," ");
    ...
    $printTestText .= "-------------------------------------------------------------------------------------------------------------------\n";
		...
		$no = 1; 
		$tampil = mysqli_query($connection,"SELECT * from detail_transaksi o left join produk p on o.c_codeprod=p.c_prodcode where id_transaksi='002'");
