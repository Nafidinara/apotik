				...
				<div class="box-body">
				  ...
				  <table id="example1" class="display table table-bordered table-striped" width="100%">
					...
					$connection = mysqli_connect("localhost", "root", "","apotik");
						$no = 1; 
						$tampil = mysqli_query($connection,"SELECT p.*,d.C_DEPNAME, j.C_NAMAJAB from ptk p 
			...
			<div class="box-body ">
				<table class="table table-hover">
					...
					<tr>
						<td>Pendidikan</td>
						<td>:</td>
						<td><?php $tampil = mysqli_query($connection,"SELECT * FROM ptk_detail WHERE JENIS='PENDIDIKAN' AND ID_PTK='$_GET[ID_PTK]'");
						while($h=mysqli_fetch_array($tampil)){
					...
					<tr>
						<td>Pengalaman</td>
						<td>:</td>
						<td><?php $tampil = mysqli_query($connection,"SELECT * FROM ptk_detail WHERE JENIS='PENGALAMAN' AND ID_PTK='$_GET[ID_PTK]'");
					...
					<tr>
						<td>Keterampilan</td>
						<td>:</td>
						<td><?php $tampil = mysqli_query($connection,"SELECT * FROM ptk_detail WHERE JENIS='SKILL' AND ID_PTK='$_GET[ID_PTK]'");
						while($y=mysqli_fetch_array($tampil)){
				...
				<br>
				<?php $s = mysqli_query($connection,"SELECT ID_KARYAWAN,C_NIP,C_NAMA,D_MASUK FROM mskry WHERE ID_PTK='$_GET[ID_PTK]'"); 			
