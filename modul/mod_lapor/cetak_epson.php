...
<table width="890" border="0">
  <tr align="center" >
    <td width="474"><span class="style1">FAKTUR KOMERSIL</span><br />
      <span class="style4">PT. APOTIK OKESOB</span><br />
...
<?php
		$no = 1;
		$g = mysqli_query($connection,"SELECT transaksi.* , admins.nama_lengkap FROM transaksi JOIN admins ON transaksi.created_user = admins.nik");
		$t=mysqli_fetch_array($g);
		?>
<input type="hidden" name="id_transaksi" value="<?php echo"$t[id_transaksi]"; ?>">
					<table width="770" border="0" style="margin-bottom: 15px;">
					  <tr>
						<td width="64" valign="top" class="style5"><span class="style12">Faktur</span></td>
						<td width="161" valign="top" class="style5"><span class="style12">: <?php echo"$_GET[id_transaksi]"; ?></span></td>
						  <td class="style12">&nbsp;</td>
					  ...
					  <tr>
						...
						<td class="style5"><span class="style12">: <? echo(date('Y-m-d')); ?>  </span></td>
						<td class="style12">&nbsp;</td>
						<td class="style5"><span class="style12">jam</span></td>
						<td class="style5"><span class="style12">: <?php echo(date('H:i:s')); ?> </span></td>
					  </tr>

					</table>

					<table width="890" border="1" cellpadding="1" cellspacing="0" class="tablep">
					  <tr>
					  <td colspan="7">
						</td>
</tr>
					 ...
					 $waktu = date('Y-m-d');
							$no = 1;
							$tampil = mysqli_query($connection,"SELECT * from detail_transaksi where id_transaksi='$_GET[id_transaksi]' and tanggal='$waktu'");
    ...
    margin-right: 15;
">Print/Cetak</button>
					<a href="../../media.php?module=lapor" class="hilang">Kembali</a>
