 <?php
$folder="modul/mod_lapor";
$aksi="modul/mod_lapor/aksi_transaksi.php";
switch($_GET['act']){
  default:
  ?>
<?php
	...
	<section class="content">
		<div class="row">
			...
			<div class="box">
				...
				<?php
echo"<form action='$aksi?module=lapor&act=inputPrint'
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
				  ...
				  <form method="post" class="formPendidikan">
					...
					<div class="modal-footer">
						<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
						<a type="submit" class="simpanPend btn btn-primary">Cetak</a>
					</div>
				  </form>
				</div>
			</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(".simpanPend").click(function(){
				...
				$.ajax({
					type: 'POST',
					url: "modul/mod_lapor/simpanOrderTemp.php",
					data: data
					,
					success: function() {
						$('#tampildata').load("<?php echo"$folder"; ?>/show_tabel.php");
				  ...
				  <table id="hrd" class="display table table-bordered table-striped" width="100%">
					...
					<?php
					   ...
					   echo " <tr>
						...
						<td>$r[tgl_beli]</td>
						<td><a href='modul/mod_lapor/cetak_epson.php?act=cetak_transaksi&id_transaksi=$r[id_transaksi]' class='btn bg-blue smallbtn'><i class='fa fa-fw fa-edit'></i></a>
						</td>
						</tr>";
