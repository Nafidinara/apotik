				...
				<div class="box-body">
				  ...
				  <table id="hrd1" class="display table" width="100%">
					...
					$connection = mysqli_connect("localhost", "root","","apotik");
						$no = 1;
						$tampil = mysqli_query($connection,"select * from produk p left join kategori k on p.kategori=k.kd_kategori left join suppliyer s on p.suppliyer=s.id_suppliyer");
