...
<th></th>
          ...
          <?php
            $connection = mysqli_connect("localhost", "root", "","apotik");
						$no = 1;
						$tampil = mysqli_query($connection,"select * from member");
  ...
  <div id="ModalPen" class="modal fade small" tabindex="-1"  data-focus-on="input:first" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        <?php
        $n = mysqli_query($connection,"SELECT SUBSTRING(kd_member, 2 ,4) kd_member from member order by kd_member DESC LIMIT 1");
